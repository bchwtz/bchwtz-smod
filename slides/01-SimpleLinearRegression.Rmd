...
- $Cor(Y,X)$ can be interpreted in two ways, either as
  ...
  + ratio of the covariance to the standard deviations of the two variables
...
$$\hat\beta_1 = \frac{\sum(y_i - \bar y)(x_i - \bar x)}{\sum (x_i - \bar x)} \quad\text{and}\quad \hat\beta_0 = \bar y - \hat\beta_1 \bar x$$
